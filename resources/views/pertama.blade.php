...
<html>
    ...
    <h2 style="color: #2b2070;">Bantu Adaptasi Mahasiswa Baru, ITS Gelar Mentoring Agama Islam</h2>
    <h6>Oleh : itsash <i>|</i> 18 <i>|</i> Source : ITS Online</h6>
    <p>
        <img src="https://www.its.ac.id/news/wp-content/uploads/sites/2/2025/02/IMG_20250223_084851-1536x864.jpg" width="600">
    </p>
            <p class="kalimatpembuka">Kampus ITS, ITS News — Institut Teknologi Sepuluh Nopember (ITS) menggelar Mentoring Agama Islam Semester Genap 2024/2025 dengan berbagai rangkaian kegiatan. Kegiatan ini bertujuan membentuk karakter mahasiswa baru (maba) muslim berbasis nilai-nilai Islam. Acara yang resmi dibuka dalam kuliah umum ini berlangsung di Masjid Manarul Ilmi ITS, Sabtu (22/02).</p>
            ...
            <div class="container">
                <div class="divx">Mentoring Agama Islam</div>
            </div>
            <br>
            <div class="container">
                <div class="divy">Institut Teknologi Sepuluh Nopember</div>
            </div>
            <h5>Dokumentasi Mentoring Agama Islam: </h5>
            <br>
            <br>
            <div class="container3d">
                <div class="cub">
                    <div class="side front">
                        <img src="tranform.jpg" alt="front">
                    </div>
